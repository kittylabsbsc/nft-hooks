...
export type XNFTMediaDataType = CommonNFTMediaDataType & {
  tuliNFT: Omit<
    NftMediaFragment,
...
export type XNFTDataType = Omit<XNFTMediaDataType, 'pricing'> & {
...
export type NFTDataType = XNFTDataType | OpenseaNFTDataType;
